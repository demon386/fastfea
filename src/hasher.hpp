/*
    Take from https://raw.githubusercontent.com/lvv/scc/master/hasher.h
    For hashing tuple with unordered_map
 */
#ifndef FASTFEA_HASHER_H
#define FASTFEA_HASHER_H value
#include <tuple>
///////////////////  TUPLE
